...
<div class="container" style="padding: 2rem 24px;">
    <div class="page-header" style="text-align: center; margin-bottom: 3rem;">
        <h1 style="font-size: 2.5rem; margin-bottom: 1rem; color: #1f2937;">Artikel</h1>
        <p style="font-size: 1.125rem; color: #6b7280; max-width: 600px; margin: 0 auto;">
            Baca artikel terbaru tentang tips memasak, resep, dan berita seputar Dapur Al-Furqon
        </p>
    </div>

    <!-- Filter Kategori -->
    <div class="kategori-filter" style="margin-bottom: 2rem; text-align: center;">
        <a href="<?= BASEURL; ?>/artikel" class="filter-btn active">Semua</a>
        <a href="<?= BASEURL; ?>/artikel/kategori/berita" class="filter-btn">Berita</a>
        <a href="<?= BASEURL; ?>/artikel/kategori/tips" class="filter-btn">Tips</a>
        <a href="<?= BASEURL; ?>/artikel/kategori/resep" class="filter-btn">Resep</a>
        <a href="<?= BASEURL; ?>/artikel/kategori/promo" class="filter-btn">Promo</a>
    </div>
    ...
    <div class="artikel-grid">
        ...
        <?php else : ?>
            <div class="no-artikel" style="text-align: center; padding: 3rem; grid-column: 1 / -1;">
                ...
                <p style="color: #9ca3af;">Artikel akan segera hadir. Silakan kembali lagi nanti.</p>
            </div>
        <?php endif; ?>
    </div>
</div>
...
/* Container padding untuk halaman artikel */
@media (max-width: 768px) {
    .container {
        padding-left: 16px;
        padding-right: 16px;
